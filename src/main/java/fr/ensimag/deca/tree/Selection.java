...
public class Selection extends AbstractLValue {
    ...
    public Type verifyExpr(DecacCompiler compiler, EnvironmentExp localEnv,
        ...
        FieldDefinition fieldDef = fieldIdent.getFieldDefinition(); //cette ligne bizarre pck pas sur de bien avoir le bon type
        if(!type.isClass()){
        ...
        if (fieldDef.getVisibility()==Visibility.PROTECTED){
            ...
            if(!currentClass.getType().sameType(fieldIdent.getClassDefinition().getType())){
